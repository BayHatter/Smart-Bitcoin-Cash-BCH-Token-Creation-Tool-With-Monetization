# Smart Bitcoin Cash Token Creation Tool

A simple frontend tool to create tokens on the Smart Bitcoin Cash (BCH) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Smart-Bitcoin-Cash-BCH-Token-Creation-Tool-With-Monetization.git
- And press deploy
- Congrats your Smart Bitcoin Cash Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Smart-Bitcoin-Cash-BCH-Token-Creation-Tool-With-Monetization
- Upload into your Github repo.
- Edit the file public/config.json and insert your Smart Bitcoin Cash wallet address for receiving fees. Also set fee in BCH that you want to charge
